...
// Serve static files except config.js
...
app.get('/config.js', (req, res) => {
    const mainFirebaseKey = process.env.FIREBASE_API_KEY || "AIzaSyD_mPnUhcSDqlm1TJqqg9MkRwNsAAqILc4";
    const adminFirebaseKey = process.env.ADMIN_FIREBASE_API_KEY || "AIzaSyBEa40rKc6lympfQ77zhIWbavre8CGIvio";
